...
[![Build Status](https://jenkins.services.ai4os.eu/buildStatus/icon?job=AI4OS-hub/smartbay-marine-types/main)](https://jenkins.services.ai4os.eu/job/AI4OS-hub/job/smartbay-marine-types/job/main/)
...
This is a container that will run the smartbay-marine-types application leveraging the DEEP as a Service API component ([DEEPaaS API](https://github.com/ai4os/DEEPaaS)). The application is based on **ai4oshub/ai4os-yolov8-torch** module.
...
```bash
$ docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 ai4oshub/smartbay-marine-types
```
...
```bash
git clone https://github.com/ai4os-hub/smartbay-marine-types
cd smartbay-marine-types
docker build -t ai4oshub/smartbay-marine-types .
docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 ai4oshub/smartbay-marine-types
```
